...
class KBaseTypedObjConverter(object):
    ...
    def validate_simple_converter(self, c):
        resp = self._call('KBaseTypedObjConverter.validate_simple_converter',
                          [c])
        return resp[0]

    def save_simple_converter(self, c, target):
        resp = self._call('KBaseTypedObjConverter.save_simple_converter',
                          [c, target])
        return resp[0]
