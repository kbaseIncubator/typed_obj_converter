...
function KBaseTypedObjConverter(url, auth, auth_cb) {
    ...
    this.simple_convert = function (params, _callback, _errorCallback) {
    return json_call_ajax("KBaseTypedObjConverter.simple_convert",
        [params], 1, _callback, _errorCallback);
};

    this.simple_convert_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("KBaseTypedObjConverter.simple_convert", [params], 1, _callback, _error_callback);
    };
